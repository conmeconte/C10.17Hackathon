...
var locationObj=[
    {id: 1, name: "London", location: [51.5005803,-0.1258119], youTubeId:null, trivia: [
    ...
    {id: 2, name: "Istanbul", location: [41.0081056,28.9810191], youTubeId:null, trivia: "This is the only city in the world to straddle two continents: Asia and Europe."},
    {id: 3, name: "Venice", location: [45.4384184,12.3359239], youTubeId:null, trivia: "This city is made up of 118 islands."},
    {id: 4, name: "New York", location: [40.7536533,-73.9806382], youTubeId:null, trivia: "15,152 forms of life have been found in the city's train system (including insects and bacteria)."},
    {id: 5, name: "Tokyo", location: [35.7141231,139.7966704], youTubeId:null, trivia: "With a population of 26.5 million, this city is the largest in the world in terms of total population size."},
    {id: 6, name: "Los Vegas", location: [36.1126258,-115.1767051], youTubeId:null, trivia: "Michael Jackson had plans to build a 50 foot tall moon walking robot replica of himself to roam the desert of this city. It was intended to be an advertisement for a planned 2005 comeback."},
    {id: 7, name: "Cairo", location: [29.9778574,31.1287904], youTubeId:null, trivia: [
    ...
    {id: 8, name: "Beirut", location: [33.8969085,35.5023606], youTubeId:null, trivia: "There are 15 rivers in the country this city is in (all of them coming from its own mountains), and despite surrounding deserts, this country has none."},
    ...
    {id: 10, name: "Berlin", location: [52.5163767,13.3788291], youTubeId:null, trivia: [
    ...
    {id: 11, name: "Prague", location: [50.0875638,14.4212062], youTubeId:null, trivia: [
    ...
    {id: 12, name: "Havana", location: [23.1401843,-82.3508177], youTubeId:null, trivia: "Singer Gloria Estefan was born here."},
    {id: 13, name: "Shanghai", location: [31.239481,121.4998016], youTubeId:null, trivia: "This city has the second tallest building in the world, standing at 2,073 feet."},
    {id: 14, name: "Rio De Janeiro", location: [-22.9522173,-43.2102183], youTubeId:null, trivia: [
    ...
    {id: 15, name: "Sydney", location: [-33.8590761,151.2221537], youTubeId:null, trivia: [
